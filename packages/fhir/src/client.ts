...
export const getSmartFhirAccessToken = async (options: SmartFhirClientOptions): Promise<string> => {
	...
	try {
		...
		/**console.log('--- fhirclient Object Diagnostics ---')
		console.log('Type of fhirclient:', typeof fhirclient)
		if (typeof fhirclient !== 'undefined' && fhirclient !== null) {
			console.log('fhirclient object keys:', Object.keys(fhirclient))
			console.log('Type of fhirclient.oauth2:', typeof fhirclient.oauth2)
			if (typeof fhirclient.oauth2 !== 'undefined' && fhirclient.oauth2 !== null) {
				console.log('fhirclient.oauth2 object keys:', Object.keys(fhirclient.oauth2))
				console.log('Type of fhirclient.oauth2.ready:', typeof fhirclient.oauth2.ready)
			} else {
				console.log('fhirclient.oauth2 is undefined or null.')
			}
		} else {
			console.log('fhirclient object itself is undefined or null.')
		}
		console.log('--- End fhirclient Object Diagnostics ---')*/

		console.log('mergedConfig being passed to ready():', JSON.stringify(mergedConfig, null, 2))
