...
>(options?: { contained?: C; allowContained?: boolean }) {
	...
	return getCachedSchema('BiologicallyDerivedProduct', [contained], () => {
		const baseSchema: z.ZodType<types.BiologicallyDerivedProduct<z.infer<C>>> = z.strictObject({
			...
			collection: createBiologicallyDerivedProductCollectionSchema().optional(),
			processing: z.array(createBiologicallyDerivedProductProcessingSchema()).optional(),
			manipulation: createBiologicallyDerivedProductManipulationSchema().optional(),
			storage: z.array(createBiologicallyDerivedProductStorageSchema()).optional(),
		})
...
export function createBiologicallyDerivedProductCollectionSchema() {
	return getCachedSchema('BiologicallyDerivedProductCollection', [], () => {
		const baseSchema: z.ZodType<types.BiologicallyDerivedProductCollection> = z.strictObject({
...
export function createBiologicallyDerivedProductProcessingSchema() {
	return getCachedSchema('BiologicallyDerivedProductProcessing', [], () => {
		const baseSchema: z.ZodType<types.BiologicallyDerivedProductProcessing> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createBiologicallyDerivedProductManipulationSchema() {
	return getCachedSchema('BiologicallyDerivedProductManipulation', [], () => {
		const baseSchema: z.ZodType<types.BiologicallyDerivedProductManipulation> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			description: primitives.getStringSchema().optional(),
...
export function createBiologicallyDerivedProductStorageSchema() {
	return getCachedSchema('BiologicallyDerivedProductStorage', [], () => {
		const baseSchema: z.ZodType<types.BiologicallyDerivedProductStorage> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			description: primitives.getStringSchema().optional(),
