...
export function createDocumentManifestSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('DocumentManifest', [contained], () => {
		const baseSchema: z.ZodType<types.DocumentManifest<z.infer<C>>> = z.strictObject({
