...
export function createOrganizationSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('Organization', [contained], () => {
		const baseSchema: z.ZodType<types.Organization<z.infer<C>>> = z.strictObject({
...
>(options?: { contained?: C; allowContained?: boolean }) {
	...
	return getCachedSchema('OrganizationAffiliation', [contained], () => {
		const baseSchema: z.ZodType<types.OrganizationAffiliation<z.infer<C>>> = z.strictObject({
