...
export function createDocumentReferenceSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('DocumentReference', [contained], () => {
		const baseSchema: z.ZodType<types.DocumentReference<z.infer<C>>> = z.strictObject({
...
export function createDocumentReferenceRelatesToSchema() {
	return getCachedSchema('DocumentReferenceRelatesTo', [], () => {
		const baseSchema: z.ZodType<types.DocumentReferenceRelatesTo> = z.strictObject({
...
export function createDocumentReferenceContentSchema() {
	return getCachedSchema('DocumentReferenceContent', [], () => {
		const baseSchema: z.ZodType<types.DocumentReferenceContent> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createDocumentReferenceContextSchema() {
	return getCachedSchema('DocumentReferenceContext', [], () => {
		const baseSchema: z.ZodType<types.DocumentReferenceContext> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
