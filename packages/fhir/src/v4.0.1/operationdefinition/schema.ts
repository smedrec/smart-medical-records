...
export function createOperationDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('OperationDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.OperationDefinition<z.infer<C>>> = z.strictObject({
...
export function createOperationDefinitionParameterSchema() {
	return getCachedSchema('OperationDefinitionParameter', [], () => {
		const baseSchema: z.ZodType<types.OperationDefinitionParameter> = z.strictObject({
			...
			referencedFrom: z.array(createOperationDefinitionReferencedFromSchema()).optional(),
...
export function createOperationDefinitionBindingSchema() {
	return getCachedSchema('OperationDefinitionBinding', [], () => {
		const baseSchema: z.ZodType<types.OperationDefinitionBinding> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createOperationDefinitionReferencedFromSchema() {
	return getCachedSchema('OperationDefinitionReferencedFrom', [], () => {
		const baseSchema: z.ZodType<types.OperationDefinitionReferencedFrom> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createOperationDefinitionOverloadSchema() {
	return getCachedSchema('OperationDefinitionOverload', [], () => {
		const baseSchema: z.ZodType<types.OperationDefinitionOverload> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
