...
export function createResearchDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('ResearchDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.ResearchDefinition<z.infer<C>>> = z.strictObject({
