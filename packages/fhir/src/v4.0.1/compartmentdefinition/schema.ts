...
export function createCompartmentDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('CompartmentDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.CompartmentDefinition<z.infer<C>>> = z.strictObject({
...
export function createCompartmentDefinitionResourceSchema() {
	return getCachedSchema('CompartmentDefinitionResource', [], () => {
		const baseSchema: z.ZodType<types.CompartmentDefinitionResource> = z.strictObject({
