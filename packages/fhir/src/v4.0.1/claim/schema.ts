...
export function createClaimSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
...
export function createClaimResponseSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('ClaimResponse', [contained], () => {
		const baseSchema: z.ZodType<types.ClaimResponse<z.infer<C>>> = z.strictObject({
...
export function createClaimResponseAdjudicationSchema() {
	return getCachedSchema('ClaimResponseAdjudication', [], () => {
		const baseSchema: z.ZodType<types.ClaimResponseAdjudication> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			category: createCodeableConceptSchema(),
...
export function createClaimResponseProcessNoteSchema() {
	return getCachedSchema('ClaimResponseProcessNote', [], () => {
		const baseSchema: z.ZodType<types.ClaimResponseProcessNote> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
