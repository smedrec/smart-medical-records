...
export function createActivityDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('ActivityDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.ActivityDefinition<z.infer<C>>> = z.strictObject({
			...
			participant: z.array(createActivityDefinitionParticipantSchema()).optional(),
			...
			dynamicValue: z.array(createActivityDefinitionDynamicValueSchema()).optional(),
		})
...
export function createActivityDefinitionParticipantSchema() {
	return getCachedSchema('ActivityDefinitionParticipant', [], () => {
		const baseSchema: z.ZodType<types.ActivityDefinitionParticipant> = z.strictObject({
...
export function createActivityDefinitionDynamicValueSchema() {
	return getCachedSchema('ActivityDefinitionDynamicValue', [], () => {
		const baseSchema: z.ZodType<types.ActivityDefinitionDynamicValue> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
