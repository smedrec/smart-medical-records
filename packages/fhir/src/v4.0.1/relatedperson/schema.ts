...
export function createRelatedPersonSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('RelatedPerson', [contained], () => {
		const baseSchema: z.ZodType<types.RelatedPerson<z.infer<C>>> = z.strictObject({
			...
			communication: z.array(createRelatedPersonCommunicationSchema()).optional(),
		})
...
export function createRelatedPersonCommunicationSchema() {
	return getCachedSchema('RelatedPersonCommunication', [], () => {
		const baseSchema: z.ZodType<types.RelatedPersonCommunication> = z.strictObject({
