...
export function createClinicalImpressionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('ClinicalImpression', [contained], () => {
		const baseSchema: z.ZodType<types.ClinicalImpression<z.infer<C>>> = z.strictObject({
			...
			investigation: z.array(createClinicalImpressionInvestigationSchema()).optional(),
			...
			prognosisCodeableConcept: z.array(createCodeableConceptSchema()).optional(),
...
export function createClinicalImpressionInvestigationSchema() {
	return getCachedSchema('ClinicalImpressionInvestigation', [], () => {
		const baseSchema: z.ZodType<types.ClinicalImpressionInvestigation> = z.strictObject({
...
export function createClinicalImpressionFindingSchema() {
	return getCachedSchema('ClinicalImpressionFinding', [], () => {
		const baseSchema: z.ZodType<types.ClinicalImpressionFinding> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
