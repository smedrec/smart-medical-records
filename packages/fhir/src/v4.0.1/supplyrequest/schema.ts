...
export function createSupplyRequestSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('SupplyRequest', [contained], () => {
		const baseSchema: z.ZodType<types.SupplyRequest<z.infer<C>>> = z.strictObject({
