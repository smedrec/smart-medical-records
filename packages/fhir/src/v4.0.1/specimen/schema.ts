...
export function createSpecimenSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
...
export function createSpecimenDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('SpecimenDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.SpecimenDefinition<z.infer<C>>> = z.strictObject({
			...
			typeTested: z.array(createSpecimenDefinitionTypeTestedSchema()).optional(),
		})
...
export function createSpecimenDefinitionTypeTestedSchema() {
	return getCachedSchema('SpecimenDefinitionTypeTested', [], () => {
		const baseSchema: z.ZodType<types.SpecimenDefinitionTypeTested> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createSpecimenDefinitionContainerSchema() {
	return getCachedSchema('SpecimenDefinitionContainer', [], () => {
		const baseSchema: z.ZodType<types.SpecimenDefinitionContainer> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createSpecimenDefinitionAdditiveSchema() {
	return getCachedSchema('SpecimenDefinitionAdditive', [], () => {
		const baseSchema: z.ZodType<types.SpecimenDefinitionAdditive> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			additiveCodeableConcept: createCodeableConceptSchema().optional(),
...
export function createSpecimenDefinitionHandlingSchema() {
	return getCachedSchema('SpecimenDefinitionHandling', [], () => {
		const baseSchema: z.ZodType<types.SpecimenDefinitionHandling> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
