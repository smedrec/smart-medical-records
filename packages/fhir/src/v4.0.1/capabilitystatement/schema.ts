...
export function createCapabilityStatementSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('CapabilityStatement', [contained], () => {
		const baseSchema: z.ZodType<types.CapabilityStatement<z.infer<C>>> = z.strictObject({
			...
			implementation: createCapabilityStatementImplementationSchema().optional(),
			fhirVersion: z.enum([
				'0.01',
				'0.05',
				'0.06',
...
export function createCapabilityStatementSoftwareSchema() {
	return getCachedSchema('CapabilityStatementSoftware', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementSoftware> = z.strictObject({
...
export function createCapabilityStatementImplementationSchema() {
	return getCachedSchema('CapabilityStatementImplementation', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementImplementation> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createCapabilityStatementRestSchema() {
	return getCachedSchema('CapabilityStatementRest', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementRest> = z.strictObject({
			...
			interaction: z.array(createCapabilityStatementInteraction1Schema()).optional(),
			searchParam: z.array(createCapabilityStatementSearchParamSchema()).optional(),
			operation: z.array(createCapabilityStatementOperationSchema()).optional(),
...
export function createCapabilityStatementSecuritySchema() {
	return getCachedSchema('CapabilityStatementSecurity', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementSecurity> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createCapabilityStatementResourceSchema() {
	return getCachedSchema('CapabilityStatementResource', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementResource> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			...
			documentation: primitives.getMarkdownSchema().optional(),
			_documentation: createElementSchema().optional(),
			interaction: z.array(createCapabilityStatementInteractionSchema()).optional(),
...
export function createCapabilityStatementInteractionSchema() {
	return getCachedSchema('CapabilityStatementInteraction', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementInteraction> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			code: z
...
export function createCapabilityStatementSearchParamSchema() {
	return getCachedSchema('CapabilityStatementSearchParam', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementSearchParam> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			name: primitives.getStringSchema().optional(),
...
export function createCapabilityStatementOperationSchema() {
	return getCachedSchema('CapabilityStatementOperation', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementOperation> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			name: primitives.getStringSchema().optional(),
...
export function createCapabilityStatementInteraction1Schema() {
	return getCachedSchema('CapabilityStatementInteraction1', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementInteraction1> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			code: z.enum(['transaction', 'batch', 'search-system', 'history-system']).optional(),
			_code: createElementSchema().optional(),
			documentation: primitives.getMarkdownSchema().optional(),
			_documentation: createElementSchema().optional(),
		})
...
export function createCapabilityStatementMessagingSchema() {
	return getCachedSchema('CapabilityStatementMessaging', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementMessaging> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			...
			documentation: primitives.getMarkdownSchema().optional(),
			_documentation: createElementSchema().optional(),
			supportedMessage: z.array(createCapabilityStatementSupportedMessageSchema()).optional(),
		})
...
export function createCapabilityStatementEndpointSchema() {
	return getCachedSchema('CapabilityStatementEndpoint', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementEndpoint> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createCapabilityStatementSupportedMessageSchema() {
	return getCachedSchema('CapabilityStatementSupportedMessage', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementSupportedMessage> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createCapabilityStatementDocumentSchema() {
	return getCachedSchema('CapabilityStatementDocument', [], () => {
		const baseSchema: z.ZodType<types.CapabilityStatementDocument> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
