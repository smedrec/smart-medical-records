...
export function createGraphDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('GraphDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.GraphDefinition<z.infer<C>>> = z.strictObject({
...
export function createGraphDefinitionCompartmentSchema() {
	return getCachedSchema('GraphDefinitionCompartment', [], () => {
		const baseSchema: z.ZodType<types.GraphDefinitionCompartment> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
