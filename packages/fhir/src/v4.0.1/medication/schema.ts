...
export function createMedicationSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
...
>(options?: { contained?: C; allowContained?: boolean }) {
	...
	return getCachedSchema('MedicationAdministration', [contained], () => {
		const baseSchema: z.ZodType<types.MedicationAdministration<z.infer<C>>> = z.strictObject({
			...
			performer: z.array(createMedicationAdministrationPerformerSchema()).optional(),
...
export function createMedicationAdministrationPerformerSchema() {
	return getCachedSchema('MedicationAdministrationPerformer', [], () => {
		const baseSchema: z.ZodType<types.MedicationAdministrationPerformer> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationAdministrationDosageSchema() {
	return getCachedSchema('MedicationAdministrationDosage', [], () => {
		const baseSchema: z.ZodType<types.MedicationAdministrationDosage> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationDispenseSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('MedicationDispense', [contained], () => {
		const baseSchema: z.ZodType<types.MedicationDispense<z.infer<C>>> = z.strictObject({
...
export function createMedicationDispensePerformerSchema() {
	return getCachedSchema('MedicationDispensePerformer', [], () => {
		const baseSchema: z.ZodType<types.MedicationDispensePerformer> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			function: createCodeableConceptSchema().optional(),
...
export function createMedicationDispenseSubstitutionSchema() {
	return getCachedSchema('MedicationDispenseSubstitution', [], () => {
		const baseSchema: z.ZodType<types.MedicationDispenseSubstitution> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationKnowledgeSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('MedicationKnowledge', [contained], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledge<z.infer<C>>> = z.strictObject({
			...
			ingredient: z.array(createMedicationKnowledgeIngredientSchema()).optional(),
			...
			monitoringProgram: z.array(createMedicationKnowledgeMonitoringProgramSchema()).optional(),
			...
			drugCharacteristic: z.array(createMedicationKnowledgeDrugCharacteristicSchema()).optional(),
			contraindication: z.array(createReferenceSchema()).optional(),
			regulatory: z.array(createMedicationKnowledgeRegulatorySchema()).optional(),
...
export function createMedicationKnowledgeRelatedMedicationKnowledgeSchema() {
	return getCachedSchema('MedicationKnowledgeRelatedMedicationKnowledge', [], () => {
...
export function createMedicationKnowledgeMonographSchema() {
	return getCachedSchema('MedicationKnowledgeMonograph', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeMonograph> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema().optional(),
...
export function createMedicationKnowledgeIngredientSchema() {
	return getCachedSchema('MedicationKnowledgeIngredient', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeIngredient> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			itemCodeableConcept: createCodeableConceptSchema().optional(),
...
export function createMedicationKnowledgeMonitoringProgramSchema() {
	return getCachedSchema('MedicationKnowledgeMonitoringProgram', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeMonitoringProgram> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema().optional(),
...
export function createMedicationKnowledgeAdministrationGuidelinesSchema() {
	return getCachedSchema('MedicationKnowledgeAdministrationGuidelines', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeAdministrationGuidelines> = z.strictObject(
			{
				id: primitives.getStringSchema().optional(),
				extension: z.array(createExtensionSchema()).optional(),
				modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationKnowledgeDosageSchema() {
	return getCachedSchema('MedicationKnowledgeDosage', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeDosage> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema(),
...
export function createMedicationKnowledgePatientCharacteristicsSchema() {
	return getCachedSchema('MedicationKnowledgePatientCharacteristics', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgePatientCharacteristics> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationKnowledgeMedicineClassificationSchema() {
	return getCachedSchema('MedicationKnowledgeMedicineClassification', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeMedicineClassification> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema(),
...
export function createMedicationKnowledgePackagingSchema() {
	return getCachedSchema('MedicationKnowledgePackaging', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgePackaging> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema().optional(),
...
export function createMedicationKnowledgeDrugCharacteristicSchema() {
	return getCachedSchema('MedicationKnowledgeDrugCharacteristic', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeDrugCharacteristic> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema().optional(),
...
export function createMedicationKnowledgeRegulatorySchema() {
	return getCachedSchema('MedicationKnowledgeRegulatory', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeRegulatory> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			regulatoryAuthority: createReferenceSchema(),
			substitution: z.array(createMedicationKnowledgeSubstitutionSchema()).optional(),
...
export function createMedicationKnowledgeSubstitutionSchema() {
	return getCachedSchema('MedicationKnowledgeSubstitution', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeSubstitution> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema(),
...
export function createMedicationKnowledgeScheduleSchema() {
	return getCachedSchema('MedicationKnowledgeSchedule', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeSchedule> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationKnowledgeMaxDispenseSchema() {
	return getCachedSchema('MedicationKnowledgeMaxDispense', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeMaxDispense> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationKnowledgeKineticsSchema() {
	return getCachedSchema('MedicationKnowledgeKinetics', [], () => {
		const baseSchema: z.ZodType<types.MedicationKnowledgeKinetics> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationRequestSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('MedicationRequest', [contained], () => {
		const baseSchema: z.ZodType<types.MedicationRequest<z.infer<C>>> = z.strictObject({
			...
			note: z.array(createAnnotationSchema()).optional(),
			dosageInstruction: z.array(createDosageSchema()).optional(),
			dispenseRequest: createMedicationRequestDispenseRequestSchema().optional(),
...
export function createMedicationRequestDispenseRequestSchema() {
	return getCachedSchema('MedicationRequestDispenseRequest', [], () => {
		const baseSchema: z.ZodType<types.MedicationRequestDispenseRequest> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationRequestInitialFillSchema() {
	return getCachedSchema('MedicationRequestInitialFill', [], () => {
		const baseSchema: z.ZodType<types.MedicationRequestInitialFill> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			quantity: createQuantitySchema().optional(),
...
export function createMedicationRequestSubstitutionSchema() {
	return getCachedSchema('MedicationRequestSubstitution', [], () => {
		const baseSchema: z.ZodType<types.MedicationRequestSubstitution> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMedicationStatementSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('MedicationStatement', [contained], () => {
		const baseSchema: z.ZodType<types.MedicationStatement<z.infer<C>>> = z.strictObject({
