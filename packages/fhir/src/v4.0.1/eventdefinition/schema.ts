...
export function createEventDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('EventDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.EventDefinition<z.infer<C>>> = z.strictObject({
