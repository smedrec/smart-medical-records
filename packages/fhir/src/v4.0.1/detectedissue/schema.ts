...
export function createDetectedIssueSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('DetectedIssue', [contained], () => {
		const baseSchema: z.ZodType<types.DetectedIssue<z.infer<C>>> = z.strictObject({
