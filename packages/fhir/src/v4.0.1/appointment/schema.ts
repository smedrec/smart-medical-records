...
export function createAppointmentSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
...
export function createAppointmentResponseSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('AppointmentResponse', [contained], () => {
		const baseSchema: z.ZodType<types.AppointmentResponse<z.infer<C>>> = z.strictObject({
