...
export function createEnrollmentRequestSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('EnrollmentRequest', [contained], () => {
		const baseSchema: z.ZodType<types.EnrollmentRequest<z.infer<C>>> = z.strictObject({
