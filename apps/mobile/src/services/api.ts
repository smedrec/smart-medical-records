 ...
 */
export const login = async (credentials: UserCredentials): Promise<ApiResponse<{ token: string; userId: string }>> => {
 ...
 */
export const signUp = async (userInfo: UserCredentials): Promise<ApiResponse<{ userId: string }>> => {
 ...
 */
export const sendFMDAMessage = async (messageText: string, userId: string): Promise<ApiResponse<FMDAResponse>> => {
 ...
 */
export const fetchMedicalData = async (userId: string, dataType: string): Promise<ApiResponse<any>> => {
