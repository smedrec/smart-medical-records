...
import { SectionHeader, SidebarSection } from '@/components/tiny-components'
					...
					<SidebarMenu>
						<SidebarMenuItem>
							<SidebarMenuButton size="lg" asChild>
								<Link href="/dashboard" className="px-4 py-2 h-full sidebar-logo no-underline">
				...
				<SidebarFooter className="px-2 py-4">
					<SidebarMenu>
						...
						<FooterLink
							...
							label="View Source"
						/>
						<FooterLink to="/audit" Icon={TerminalIcon} label="Logs" />
						<SectionHeader className="px-0 py-0 text-xs flex gap-1 mr-2">
							<Settings className="size-4" />
							<div>Settings</div>
						</SectionHeader>
						<Separator />
						<FooterLink to="/settings/account" Icon={CircleUser} label="Account" />
						<FooterLink to="/settings/security" Icon={Fingerprint} label="Security" />
						<FooterLink to="/settings/api-keys" Icon={Key} label="Api Keys" />
						<FooterLink to="/settings/organization" Icon={Hospital} label="Organization Settings" />
					</SidebarMenu>
				</SidebarFooter>
			</Sidebar>
