...
export function createImagingStudySchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('ImagingStudy', [contained], () => {
		const baseSchema: z.ZodType<types.ImagingStudy<z.infer<C>>> = z.strictObject({
