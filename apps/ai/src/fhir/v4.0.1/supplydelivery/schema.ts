...
export function createSupplyDeliverySchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('SupplyDelivery', [contained], () => {
		const baseSchema: z.ZodType<types.SupplyDelivery<z.infer<C>>> = z.strictObject({
...
export function createSupplyDeliverySuppliedItemSchema() {
	return getCachedSchema('SupplyDeliverySuppliedItem', [], () => {
		const baseSchema: z.ZodType<types.SupplyDeliverySuppliedItem> = z.strictObject({
