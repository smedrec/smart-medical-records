...
export function createNutritionOrderSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('NutritionOrder', [contained], () => {
		const baseSchema: z.ZodType<types.NutritionOrder<z.infer<C>>> = z.strictObject({
...
export function createNutritionOrderSupplementSchema() {
	return getCachedSchema('NutritionOrderSupplement', [], () => {
		const baseSchema: z.ZodType<types.NutritionOrderSupplement> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createNutritionOrderEnteralFormulaSchema() {
	return getCachedSchema('NutritionOrderEnteralFormula', [], () => {
		const baseSchema: z.ZodType<types.NutritionOrderEnteralFormula> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			...
			administration: z.array(createNutritionOrderAdministrationSchema()).optional(),
...
export function createNutritionOrderAdministrationSchema() {
	return getCachedSchema('NutritionOrderAdministration', [], () => {
		const baseSchema: z.ZodType<types.NutritionOrderAdministration> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
