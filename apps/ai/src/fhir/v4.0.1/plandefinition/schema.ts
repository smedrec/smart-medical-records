...
export function createPlanDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('PlanDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.PlanDefinition<z.infer<C>>> = z.strictObject({
...
export function createPlanDefinitionActionSchema() {
	return getCachedSchema('PlanDefinitionAction', [], () => {
		const baseSchema: z.ZodType<types.PlanDefinitionAction> = z.strictObject({
			...
			relatedAction: z.array(createPlanDefinitionRelatedActionSchema()).optional(),
			...
			dynamicValue: z.array(createPlanDefinitionDynamicValueSchema()).optional(),
			action: z.array(createPlanDefinitionActionSchema()).optional(),
		})
...
export function createPlanDefinitionRelatedActionSchema() {
	return getCachedSchema('PlanDefinitionRelatedAction', [], () => {
		const baseSchema: z.ZodType<types.PlanDefinitionRelatedAction> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createPlanDefinitionParticipantSchema() {
	return getCachedSchema('PlanDefinitionParticipant', [], () => {
		const baseSchema: z.ZodType<types.PlanDefinitionParticipant> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: z.enum(['patient', 'practitioner', 'related-person', 'device']).optional(),
...
export function createPlanDefinitionDynamicValueSchema() {
	return getCachedSchema('PlanDefinitionDynamicValue', [], () => {
		const baseSchema: z.ZodType<types.PlanDefinitionDynamicValue> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
