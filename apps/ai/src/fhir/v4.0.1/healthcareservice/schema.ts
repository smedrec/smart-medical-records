...
export function createHealthcareServiceSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('HealthcareService', [contained], () => {
		const baseSchema: z.ZodType<types.HealthcareService<z.infer<C>>> = z.strictObject({
			...
			eligibility: z.array(createHealthcareServiceEligibilitySchema()).optional(),
			...
			availableTime: z.array(createHealthcareServiceAvailableTimeSchema()).optional(),
			notAvailable: z.array(createHealthcareServiceNotAvailableSchema()).optional(),
...
export function createHealthcareServiceEligibilitySchema() {
	return getCachedSchema('HealthcareServiceEligibility', [], () => {
		const baseSchema: z.ZodType<types.HealthcareServiceEligibility> = z.strictObject({
...
export function createHealthcareServiceAvailableTimeSchema() {
	return getCachedSchema('HealthcareServiceAvailableTime', [], () => {
		const baseSchema: z.ZodType<types.HealthcareServiceAvailableTime> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			daysOfWeek: z.enum(['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun']).array().optional(),
...
export function createHealthcareServiceNotAvailableSchema() {
	return getCachedSchema('HealthcareServiceNotAvailable', [], () => {
		const baseSchema: z.ZodType<types.HealthcareServiceNotAvailable> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
