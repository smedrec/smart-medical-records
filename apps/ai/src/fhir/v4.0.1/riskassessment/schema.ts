...
export function createRiskAssessmentSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('RiskAssessment', [contained], () => {
		const baseSchema: z.ZodType<types.RiskAssessment<z.infer<C>>> = z.strictObject({
...
export function createRiskAssessmentPredictionSchema() {
	return getCachedSchema('RiskAssessmentPrediction', [], () => {
		const baseSchema: z.ZodType<types.RiskAssessmentPrediction> = z.strictObject({
