...
import type { Appointment, AppointmentResponse } from './appointment/types'
...
import type { ChargeItem, ChargeItemDefinition } from './chargeitem/types'
import type { Claim, ClaimResponse } from './claim/types'
import type { ClinicalImpression } from './clinicalimpression/types'
import type { CodeSystem } from './codesystem/types'
import type { Communication, CommunicationRequest } from './communication/types'
...
import type { Evidence, EvidenceVariable } from './evidence/types'
import type { ExampleScenario, ExampleScenarioInstance } from './examplescenario/types'
...
import type { Measure, MeasureReport } from './measure/types'
...
import type { Observation, ObservationDefinition } from './observation/types'
import type { OperationDefinition } from './operationdefinition/types'
import type { OperationOutcome } from './operationoutcome/types'
import type { Organization, OrganizationAffiliation } from './organization/types'
...
import type { Practitioner, PractitionerRole } from './practitioner/types'
import type { Procedure } from './procedure/types'
import type { Provenance } from './provenance/types'
import type { Questionnaire, QuestionnaireResponse } from './questionnaire/types'
...
import type { Specimen, SpecimenDefinition } from './specimen/types'
