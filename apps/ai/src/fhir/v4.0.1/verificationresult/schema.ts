...
export function createVerificationResultSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('VerificationResult', [contained], () => {
		const baseSchema: z.ZodType<types.VerificationResult<z.infer<C>>> = z.strictObject({
			...
			primarySource: z.array(createVerificationResultPrimarySourceSchema()).optional(),
...
export function createVerificationResultPrimarySourceSchema() {
	return getCachedSchema('VerificationResultPrimarySource', [], () => {
		const baseSchema: z.ZodType<types.VerificationResultPrimarySource> = z.strictObject({
...
export function createVerificationResultAttestationSchema() {
	return getCachedSchema('VerificationResultAttestation', [], () => {
		const baseSchema: z.ZodType<types.VerificationResultAttestation> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			who: createReferenceSchema().optional(),
...
export function createVerificationResultValidatorSchema() {
	return getCachedSchema('VerificationResultValidator', [], () => {
		const baseSchema: z.ZodType<types.VerificationResultValidator> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
