...
export function createEncounterSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
...
export function createEncounterHospitalizationSchema() {
	return getCachedSchema('EncounterHospitalization', [], () => {
		const baseSchema: z.ZodType<types.EncounterHospitalization> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
