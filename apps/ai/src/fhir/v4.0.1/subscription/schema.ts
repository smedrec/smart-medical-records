...
export function createSubscriptionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('Subscription', [contained], () => {
		const baseSchema: z.ZodType<types.Subscription<z.infer<C>>> = z.strictObject({
