...
export function createDeviceSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
...
export function createDeviceDefinitionSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('DeviceDefinition', [contained], () => {
		const baseSchema: z.ZodType<types.DeviceDefinition<z.infer<C>>> = z.strictObject({
			...
			modifierExtension: z.array(createExtensionSchema()).optional(),
			identifier: z.array(createIdentifierSchema()).optional(),
			udiDeviceIdentifier: z.array(createDeviceDefinitionUdiDeviceIdentifierSchema()).optional(),
			...
			_modelNumber: createElementSchema().optional(),
			type: createCodeableConceptSchema().optional(),
			specialization: z.array(createDeviceDefinitionSpecializationSchema()).optional(),
...
export function createDeviceDefinitionUdiDeviceIdentifierSchema() {
	return getCachedSchema('DeviceDefinitionUdiDeviceIdentifier', [], () => {
		const baseSchema: z.ZodType<types.DeviceDefinitionUdiDeviceIdentifier> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createDeviceDefinitionDeviceNameSchema() {
	return getCachedSchema('DeviceDefinitionDeviceName', [], () => {
		const baseSchema: z.ZodType<types.DeviceDefinitionDeviceName> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			name: primitives.getStringSchema(),
...
export function createDeviceDefinitionSpecializationSchema() {
	return getCachedSchema('DeviceDefinitionSpecialization', [], () => {
		const baseSchema: z.ZodType<types.DeviceDefinitionSpecialization> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createDeviceDefinitionCapabilitySchema() {
	return getCachedSchema('DeviceDefinitionCapability', [], () => {
		const baseSchema: z.ZodType<types.DeviceDefinitionCapability> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema(),
...
export function createDeviceDefinitionPropertySchema() {
	return getCachedSchema('DeviceDefinitionProperty', [], () => {
		const baseSchema: z.ZodType<types.DeviceDefinitionProperty> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
			type: createCodeableConceptSchema(),
...
export function createDeviceDefinitionMaterialSchema() {
	return getCachedSchema('DeviceDefinitionMaterial', [], () => {
		const baseSchema: z.ZodType<types.DeviceDefinitionMaterial> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createDeviceMetricSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('DeviceMetric', [contained], () => {
		const baseSchema: z.ZodType<types.DeviceMetric<z.infer<C>>> = z.strictObject({
...
export function createDeviceRequestSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('DeviceRequest', [contained], () => {
		const baseSchema: z.ZodType<types.DeviceRequest<z.infer<C>>> = z.strictObject({
...
export function createDeviceUseStatementSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	allowContained?: boolean
}) {
	const contained =
	...
	return getCachedSchema('DeviceUseStatement', [contained], () => {
		const baseSchema: z.ZodType<types.DeviceUseStatement<z.infer<C>>> = z.strictObject({
