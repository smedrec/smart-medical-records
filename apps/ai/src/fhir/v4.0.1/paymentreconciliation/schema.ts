...
export function createPaymentReconciliationSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('PaymentReconciliation', [contained], () => {
		const baseSchema: z.ZodType<types.PaymentReconciliation<z.infer<C>>> = z.strictObject({
			...
			processNote: z.array(createPaymentReconciliationProcessNoteSchema()).optional(),
		})
...
export function createPaymentReconciliationDetailSchema() {
	return getCachedSchema('PaymentReconciliationDetail', [], () => {
		const baseSchema: z.ZodType<types.PaymentReconciliationDetail> = z.strictObject({
...
export function createPaymentReconciliationProcessNoteSchema() {
	return getCachedSchema('PaymentReconciliationProcessNote', [], () => {
		const baseSchema: z.ZodType<types.PaymentReconciliationProcessNote> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
