...
export function createMolecularSequenceSchema<C extends z.ZodTypeAny = z.ZodUnknown>(options?: {
	contained?: C
	...
	return getCachedSchema('MolecularSequence', [contained], () => {
		const baseSchema: z.ZodType<types.MolecularSequence<z.infer<C>>> = z.strictObject({
			...
			structureVariant: z.array(createMolecularSequenceStructureVariantSchema()).optional(),
		})
...
export function createMolecularSequenceReferenceSeqSchema() {
	return getCachedSchema('MolecularSequenceReferenceSeq', [], () => {
		const baseSchema: z.ZodType<types.MolecularSequenceReferenceSeq> = z.strictObject({
...
export function createMolecularSequenceVariantSchema() {
	return getCachedSchema('MolecularSequenceVariant', [], () => {
		const baseSchema: z.ZodType<types.MolecularSequenceVariant> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMolecularSequenceQualitySchema() {
	return getCachedSchema('MolecularSequenceQuality', [], () => {
		const baseSchema: z.ZodType<types.MolecularSequenceQuality> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMolecularSequenceRepositorySchema() {
	return getCachedSchema('MolecularSequenceRepository', [], () => {
		const baseSchema: z.ZodType<types.MolecularSequenceRepository> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
...
export function createMolecularSequenceStructureVariantSchema() {
	return getCachedSchema('MolecularSequenceStructureVariant', [], () => {
		const baseSchema: z.ZodType<types.MolecularSequenceStructureVariant> = z.strictObject({
			id: primitives.getStringSchema().optional(),
			extension: z.array(createExtensionSchema()).optional(),
			modifierExtension: z.array(createExtensionSchema()).optional(),
