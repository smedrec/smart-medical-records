/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 422a0c80509a1a5a78c4319e2d1c7717)
// Runtime types generated with workerd@1.20250525.0 2025-04-01 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		DEV: "development";
		GROQ_API_KEY: "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";
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV" | "GROQ_API_KEY">> {}
}
