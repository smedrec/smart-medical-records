...
const mockMedicalData = {
	...
	medications: [{ id: 'x', name: 'Lisinopril', dosage: '10mg', frequency: 'Once daily' }],
}
		...
		<SafeAreaView className="flex-1 bg-gray-100">
			<ScrollView className="flex-1">
				<View className="p-4 bg-white border-b border-gray-200">
					<Text className="text-xl font-semibold text-center text-blue-600">
				...
				<View className="p-4">
					...
					<View className="bg-white p-4 rounded-lg shadow mb-4">
						...
						<Text className="text-base text-gray-600">
							Blood Type: {data.patientInfo.bloodType}
						</Text>
					</View>
					...
					<View className="bg-white p-4 rounded-lg shadow mb-4">
						...
						{data.recentAppointments.map((appt) => (
							<View
								key={appt.id}
								className="mb-2 pb-2 border-b border-gray-200 last:border-b-0 last:pb-0 last:mb-0"
							>
