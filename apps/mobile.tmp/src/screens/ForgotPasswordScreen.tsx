    ...
    <SafeAreaView className="flex-1 bg-gray-100">
      <View className="flex-1 justify-center items-center p-6">
        ...
        <View className="w-full bg-white p-8 rounded-xl shadow-lg">
          <Text className="text-2xl font-semibold text-gray-700 mb-2 text-center">Forgot Password?</Text>
          ...
          >
            <Text className="text-white text-base font-semibold text-center">Reset Password</Text>
          </TouchableOpacity>

          <View className="flex-row justify-center items-center mt-4">
            <TouchableOpacity>
              <Text className="text-sm text-blue-600 hover:underline">Back to Login</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
