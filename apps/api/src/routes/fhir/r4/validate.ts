...
const route = createRoute({
	tags: ['ResourceR4'],
	operationId: 'resource-read-history',
	method: 'get',
	path: '/fhir/r4/{resourceType}/validate',
	security: [{ cookieAuth: [] }],
	request: {
...
export type ResourceReadHistoryResponse = z.infer<
...
export const registerResourceReadHistory = (app: App) =>
	app.openapi(route, async (c) => {
		...
		} = await (fhir.GET as any)(`/${resourceType}/{id}/_history`, {
			params: {
				path: { id: id },
			},
		})
