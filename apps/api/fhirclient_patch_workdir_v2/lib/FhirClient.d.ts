...
export default class FhirClient {
	 ...
	 */
	patch<ResolveType = fhirclient.FHIR.Resource>(
		url: string,
	...
	): AsyncGenerator<import('fhir/r4').FhirResource, void, unknown>
	/**
	 * Given a FHIR Bundle or a URL pointing to a bundle, iterates over all
	...
	): AsyncGenerator<Bundle<import('fhir/r4').FhirResource>, void, unknown>
	/**
