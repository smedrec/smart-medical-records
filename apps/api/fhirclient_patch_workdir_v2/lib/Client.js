...
class Client extends FhirClient_1.default {
	...
	refresh(requestOptions = {}) {
		...
		const refreshToken =
			(_b = (_a = this.state) === null || _a === void 0 ? void 0 : _a.tokenResponse) === null ||
			_b === void 0
				? void 0
				: _b.refresh_token
		...
		if (!this._refreshTask) {
			...
			const refreshRequestOptions = Object.assign(
				Object.assign(
					{
			...
			this._refreshTask = (0, lib_1.request)(tokenUri, refreshRequestOptions)
				.then((data) => {
					...
					this.state.tokenResponse = Object.assign(
						Object.assign({}, this.state.tokenResponse),
						data
					)
