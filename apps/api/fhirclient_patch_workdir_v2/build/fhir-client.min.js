														...
														for (;;)
															switch ((t.prev = t.next)) {
																...
																case 6:
																	...
																	return (
																		(t.next = 11),
																		this.fetchReferences(c.resource, r, n, o, a)
																	)
																case 11:
																	t.next = 6
																	break
											...
											return o.default.wrap(function (t) {
												for (;;)
													switch ((t.prev = t.next)) {
														case 0:
															return (
																(sessionStorage[e] = JSON.stringify(r)),
																t.abrupt('return', r)
															)
														case 2:
														case 'end':
				...
				;((t.exports = function (t, e) {
					...
					if (Object.getOwnPropertySymbols) {
						...
						for (o = 0; o < a.length; o++)
							((r = a[o]),
								-1 === e.indexOf(r) && {}.propertyIsEnumerable.call(t, r) && (i[r] = t[r]))
					}
					return i
				}),
					(t.exports.__esModule = !0),
						...
						;((this.entries = []),
							...
							void 0 !== t &&
								(k(t)
									? this.parseObject(t)
									: this.parseQuery(
											'string' == typeof t ? ('?' === Y(t, 0) ? rt(t, 1) : t) : A(t)
										)))
					}
				vt.prototype = {
					type: I,
