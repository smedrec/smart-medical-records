/******/ ;(() => {
			...
			/***/ (__unused_webpack_module, exports, __webpack_require__) => {
				...
				class Client extends FhirClient_1.default {
					...
					async request(requestOptions, fhirOptions = {}, _resolvedRefs = {}) {
						...
						return (
							super
								.fhirRequest(url, requestOptions)
								.then((result) => {
						...
						if (!this._refreshTask) {
							...
							this._refreshTask = (0, lib_1.request)(tokenUri, refreshRequestOptions)
								...
								.catch((error) => {
									...
									if (
										(_b =
											(_a = this.state) === null || _a === void 0 ? void 0 : _a.tokenResponse) ===
											null || _b === void 0
											? void 0
											: _b.refresh_token
									) {
  ...
  \****************************************/
			/***/ (__unused_webpack_module, exports, __webpack_require__) => {
				...
				const BrowserStorage_1 = __webpack_require__(
				...
				const js_base64_1 = __webpack_require__(
  ...
  \******************************/
			/***/ (module, __unused_webpack_exports, __webpack_require__) => {
				...
				// global FHIR object
				const BrowserAdapter_1 = __webpack_require__(
  ...
  \********************/
			/***/ (__unused_webpack_module, exports, __webpack_require__) => {
				...
				function getPatientParam(conformance, resourceType) {
					...
					const out = settings_1.patientParams.find((p) =>
						meta.searchParam.find((x) => x.name == p)
					)
  ...
  \*********************************/
			/***/ (__unused_webpack_module, exports, __webpack_require__) => {
				...
				const generatePKCEChallenge = async (entropy = 96) => {
					...
					const codeChallenge = (0, js_base64_1.fromUint8Array)(
						await digestSha256(codeVerifier),
						true
					)
					return {
						codeChallenge,
  ...
  \**********************/
			/***/ (__unused_webpack_module, exports, __webpack_require__) => {
				...
				async function authorize(env, params = {}) {
					...
					stateKey =
						stateKey !== null && stateKey !== void 0 ? stateKey : (0, lib_1.randomString)(16)
				...
				async function ready(env, options = {}) {
					...
					const authorized =
						!code ||
						((_a = state.tokenResponse) === null || _a === void 0 ? void 0 : _a.access_token)
					...
					if (!authorized && state.tokenUri) {
						...
						debug(
							((_b = state.tokenResponse) === null || _b === void 0 ? void 0 : _b.access_token)
								? 'Already authorized'
				...
				async function buildTokenRequest(env, { code, state, clientPublicKeySetUrl, privateKey }) {
					...
					// Asymmetric auth
						...
						const pk =
							'key' in privateKey ? privateKey.key : await env.security.importJWK(privateKey)
						const jwtHeaders = {
							typ: 'JWT',
							kid: privateKey.kid,
