/******/ ;(function () {
						...
						_createClass(AbortSignal, [
							...
							},
							{
								...
								value: function dispatchEvent(event) {
									...
									_get(_getPrototypeOf(AbortSignal.prototype), 'dispatchEvent', this).call(
										this,
										event
									)
								},
  ...
  \*******************************************/
			/***/ function (module, exports, __webpack_require__) {
				...
				module.exports = __webpack_require__(/*! ./common */ './node_modules/debug/src/common.js')(
					exports
				)
			...
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				function setup(env) {
					...
					function disable() {
						var namespaces = []
							.concat(
								(0, _toConsumableArray2.default)(createDebug.names.map(toNamespace)),
  ...
  \***********************/
			/***/ function (__unused_webpack_module, exports, __webpack_require__) {
				...
				__webpack_require__(
					/*! core-js/modules/es.array.flat.js */ './node_modules/core-js/modules/es.array.flat.js'
				)
				__webpack_require__(
				...
				__webpack_require__(
					/*! core-js/modules/es.array.unscopables.flat.js */ './node_modules/core-js/modules/es.array.unscopables.flat.js'
				)
				__webpack_require__(
				...
				__webpack_require__(
					/*! core-js/modules/es.string.search.js */ './node_modules/core-js/modules/es.string.search.js'
				)
				__webpack_require__(
				...
				__webpack_require__(
					/*! core-js/modules/web.url.js */ './node_modules/core-js/modules/web.url.js'
				)
				__webpack_require__(
					...
					return (
						...
						(0, _possibleConstructorReturn2.default)(
							...
							_isNativeReflectConstruct()
								? Reflect.construct(o, e || [], (0, _getPrototypeOf2.default)(t).constructor)
								: o.apply(t, e)
						)
					)
				}
				...
				// @ts-ignore
				var _ref =
						typeof FHIRCLIENT_PURE !== 'undefined'
							? window
							: __webpack_require__(
				...
				function _contextualize() {
					_contextualize = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(function _callee8(requestOptions, client) {
										...
										case 0:
											_contextualURL = function _contextualURL3() {
												_contextualURL = (0, _asyncToGenerator2.default)(
													/*#__PURE__*/ _regenerator.default.mark(function _callee7(_url) {
															...
															while (1)
																switch ((_context7.prev = _context7.next)) {
																	case 0:
																		...
																		;(0, lib_1.assert)(
																			resourceType,
																			'Invalid url "'.concat(_url, '"')
																		)
																		;(0, lib_1.assert)(
																			settings_1.patientCompartment.indexOf(resourceType) > -1,
																			'Cannot filter "'.concat(
																				resourceType,
																				'" resources by patient'
																			)
																		)
																		_context7.next = 5
																		return (0, lib_1.fetchConformanceStatement)(
																			client.state.serverUrl
																		)
																	case 5:
																		conformance = _context7.sent
																		searchParam = (0, lib_1.getPatientParam)(
																			conformance,
																			resourceType
																		)
					...
					return (0, _createClass2.default)(Client, [
						...
						},
						{
							...
							value: (function () {
								var _request = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(function _callee6(requestOptions) {
										var _this2 = this
										var fhirOptions,
											_resolvedRefs,
											_a,
											...
											function _callee6$(_context6) {
												while (1)
													switch ((_context6.prev = _context6.next)) {
														case 0:
															fhirOptions =
																_args6.length > 1 && _args6[1] !== undefined ? _args6[1] : {}
															_resolvedRefs =
																_args6.length > 2 && _args6[2] !== undefined ? _args6[2] : {}
															...
															options = {
																...
																pageLimit:
																	(_a = fhirOptions.pageLimit) !== null && _a !== void 0 ? _a : 1,
																resolveReferences: (0, lib_1.makeArray)(
														...
														case 11:
															...
															if (authHeader) {
																requestOptions.headers = _objectSpread(
																	_objectSpread({}, requestOptions.headers),
																	{},
																	{
																							...
																							while (1)
																								switch ((_context3.prev = _context3.next)) {
																									case 0:
																										...
																										if (
																											_this2.getState('tokenResponse.access_token')
																										) {
																											_context3.next = 4
																											break
																										}
																									...
																									case 10:
																										...
																										debugRequest(
																											'Auto-refresh failed! Please re-launch the app.'
																										)
																										_context3.next = 13
																										return _this2._clearState()
																									case 13:
						...
						},
						{
							...
							value: function refresh() {
								...
								var refreshToken =
									(_b = (_a = this.state) === null || _a === void 0 ? void 0 : _a.tokenResponse) ===
										null || _b === void 0
										? void 0
										: _b.refresh_token
								...
								if (!this._refreshTask) {
									...
									this._refreshTask = (0, lib_1.request)(tokenUri, refreshRequestOptions)
										.then(function (data) {
											...
											_this3.state.tokenResponse = _objectSpread(
												_objectSpread({}, _this3.state.tokenResponse),
												data
											)
											_this3.state.expiresAt = (0, lib_1.getAccessTokenExpiration)(
												data,
												_this3.environment
											)
											return _this3.state
										...
										.catch(function (error) {
											...
											if (
												(_b =
													(_a = _this3.state) === null || _a === void 0
														? void 0
														: _a.tokenResponse) === null || _b === void 0
													? void 0
													: _b.refresh_token
											) {
  ...
  \***************************/
			/***/ function (__unused_webpack_module, exports, __webpack_require__) {
				...
				var _awaitAsyncGenerator2 = _interopRequireDefault(
					__webpack_require__(
						/*! @babel/runtime/helpers/awaitAsyncGenerator */ './node_modules/@babel/runtime/helpers/awaitAsyncGenerator.js'
					)
				)
				var _wrapAsyncGenerator2 = _interopRequireDefault(
					__webpack_require__(
						/*! @babel/runtime/helpers/wrapAsyncGenerator */ './node_modules/@babel/runtime/helpers/wrapAsyncGenerator.js'
					)
				)
				var _excluded = ['limit']
					...
					return (0, _createClass2.default)(FhirClient, [
						{
							...
							value: (function () {
								var _create = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(
										function _callee(resource, requestOptions) {
											return _regenerator.default.wrap(
						...
						},
						{
							...
							value: (function () {
								var _update = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(
										function _callee2(resource, requestOptions) {
											return _regenerator.default.wrap(
												function _callee2$(_context2) {
													while (1)
														switch ((_context2.prev = _context2.next)) {
															case 0:
																return _context2.abrupt(
																	'return',
																	this.fhirRequest(
																		''.concat(resource.resourceType, '/').concat(resource.id),
																		_objectSpread(
																			_objectSpread({}, requestOptions),
																			{},
																			{
						...
						},
						{
							...
							value: (function () {
								var _delete2 = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(function _callee3(url) {
										var requestOptions,
											_args3 = arguments
										return _regenerator.default.wrap(
											function _callee3$(_context3) {
												while (1)
													switch ((_context3.prev = _context3.next)) {
														case 0:
															requestOptions =
																_args3.length > 1 && _args3[1] !== undefined ? _args3[1] : {}
						...
						},
						{
							key: 'patch',
							value: (function () {
								var _patch2 = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(function _callee4(url, _patch) {
										var requestOptions,
											_args4 = arguments
										return _regenerator.default.wrap(
											function _callee4$(_context4) {
						...
						},
						{
							key: 'resolveRef',
							value: (function () {
								var _resolveRef = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(
										function _callee5(obj, path, graph, cache) {
											var _this3 = this
											var requestOptions,
												node,
												isArray,
											...
											return _regenerator.default.wrap(function _callee5$(_context5) {
												while (1)
													switch ((_context5.prev = _context5.next)) {
														case 0:
															requestOptions =
																_args5.length > 4 && _args5[4] !== undefined ? _args5[4] : {}
																				...
																				return _this3
																					...
																					.catch(function (ex) {
																						if (
																							...
																							console.warn(
																								'Missing reference '.concat(ref, '. ').concat(ex)
																							)
																						} else {
																							throw ex
																						}
						...
						},
						{
							...
							value: (function () {
								var _resolveReferences = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(function _callee6(resource, references) {
										var requestOptions,
											_args6 = arguments
										return _regenerator.default.wrap(
											function _callee6$(_context6) {
						...
						},
						{
							key: 'fetchReferences',
							value: (function () {
								var _fetchReferences = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(
										function _callee7(resource, references, graph) {
											var _this4 = this
											var cache,
												requestOptions,
												_iterator2,
												...
												function _callee7$(_context7) {
													while (1)
														switch ((_context7.prev = _context7.next)) {
															case 0:
																cache =
																	_args7.length > 3 && _args7[3] !== undefined ? _args7[3] : {}
																requestOptions =
																	_args7.length > 4 && _args7[4] !== undefined ? _args7[4] : {}
																...
																Object.keys(groups)
																	...
																	.forEach(function (len) {
																		...
																		task = task.then(function () {
																			return Promise.all(
																				group.map(function (path) {
																					return _this4.resolveRef(
																						resource,
																						path,
																						graph,
																						cache,
						...
						},
						{
							key: 'getReferences',
							value: (function () {
								var _getReferences = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(function _callee8(resource, references) {
										var requestOptions,
											refs,
											out,
											key,
											...
											function _callee8$(_context8) {
												while (1)
													switch ((_context8.prev = _context8.next)) {
														case 0:
															requestOptions =
																_args8.length > 2 && _args8[2] !== undefined ? _args8[2] : {}
															_context8.next = 3
															return this.fetchReferences(
																resource,
																references,
										...
										return _regenerator.default.wrap(function _callee10$(_context10) {
											while (1)
												switch ((_context10.prev = _context10.next)) {
													...
													case 16:
														// Find the "next" link
														nextLink = ((_b = page.link) !== null && _b !== void 0 ? _b : []).find(
															function (l) {
						...
						},
						{
							key: 'fhirRequest',
							value: (function () {
								var _fhirRequest = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(function _callee11(uri) {
										var options,
											path,
											url,
											cacheMap,
											...
											function _callee11$(_context11) {
												while (1)
													switch ((_context11.prev = _context11.next)) {
														case 0:
															options =
																_args11.length > 1 && _args11[1] !== undefined ? _args11[1] : {}
															;(0, lib_1.assert)(
																options,
																'fhirRequest requires a uri as first argument'
															)
															path = uri + ''
						...
						},
						{
							key: 'getFhirVersion',
							value: (function () {
								var _getFhirVersion = (0, _asyncToGenerator2.default)(
													...
													switch ((_context12.prev = _context12.next)) {
														case 0:
															return _context12.abrupt(
																'return',
																(0, lib_1.fetchConformanceStatement)(this.fhirBaseUrl).then(
																	function (metadata) {
						...
						},
						{
							key: 'getFhirRelease',
							value: (function () {
								var _getFhirRelease = (0, _asyncToGenerator2.default)(
													...
													switch ((_context13.prev = _context13.next)) {
														case 0:
															return _context13.abrupt(
																'return',
																this.getFhirVersion().then(function (v) {
																	var _a
																	return (_a = settings_1.fhirVersions[v]) !== null && _a !== void 0
																		? _a
																		: 0
																})
															)
			...
			/***/ function (__unused_webpack_module, exports, __webpack_require__) {
				...
				var HttpError = /*#__PURE__*/ (function (_Error) {
					function HttpError(response) {
						...
						_this = _callSuper(this, HttpError, [
							''
  ...
  \****************************************/
			/***/ function (__unused_webpack_module, exports, __webpack_require__) {
				...
				var BrowserStorage_1 = __webpack_require__(
					/*! ../storage/BrowserStorage */ './src/storage/BrowserStorage.ts'
				)
  ...
  \******************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var BrowserAdapter_1 = __webpack_require__(
					/*! ../adapters/BrowserAdapter */ './src/adapters/BrowserAdapter.ts'
				)
				var FhirClient_1 = __webpack_require__(/*! ../FhirClient */ './src/FhirClient.ts')
				...
				if (typeof FHIRCLIENT_PURE == 'undefined') {
					...
					__webpack_require__(
						/*! abortcontroller-polyfill/dist/abortcontroller-polyfill-only */ './node_modules/abortcontroller-polyfill/dist/abortcontroller-polyfill-only.js'
					)
					if (!window.fetch) {
			...
			/***/ function (__unused_webpack_module, exports, __webpack_require__) {
				...
				function _checkResponse() {
					_checkResponse = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(function _callee(resp) {
							var error
							return _regenerator.default.wrap(function _callee$(_context) {
								while (1)
									switch ((_context.prev = _context.next)) {
				...
				function fetchConformanceStatement() {
					...
					return getAndCache(url, requestOptions).catch(function (ex) {
						throw new Error(
							'Failed to fetch the conformance statement from "'.concat(url, '". ').concat(ex)
						)
					})
				}
				...
				function setPath(obj, path, value) {
					...
					path
						.trim()
						.split('.')
						.reduce(function (out, key, idx, arr) {
				...
				function byCodes(observations, property) {
					...
					return function () {
						for (
							var _len = arguments.length, codes = new Array(_len), _key = 0;
							_key < _len;
							_key++
						) {
				...
				function getPatientParam(conformance, resourceType) {
					...
					if (!meta) {
						throw new Error(
							'Resource "'.concat(resourceType, '" is not supported by this FHIR server')
						)
					}
					// Check if any search parameters are available for this resource
					if (!Array.isArray(meta.searchParam)) {
						throw new Error(
							'No search parameters supported for "'.concat(resourceType, '" on this FHIR server')
						)
					}
					// This is a rare case but could happen in generic workflows
					if (
						resourceType == 'Patient' &&
						meta.searchParam.find(function (x) {
							return x.name == '_id'
						})
					) {
						return '_id'
				...
				function _getTargetWindow() {
					_getTargetWindow = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(function _callee2(target) {
							var width,
								height,
								error,
								targetWindow,
									...
									while (1)
										switch ((_context2.prev = _context2.next)) {
											...
											case 8:
												...
												_debug(
													"Invalid target type '%s'. Failing back to '_self'.",
													(0, _typeof2.default)(target)
												)
				...
				function assertJsonPatch(patch) {
					...
					patch.forEach(function (operation) {
						...
						assert(
							operation.path && (0, _typeof2.default)(operation.path),
							'Invalid "'.concat(operation.op, '" operation. Missing "path" property')
						)
						if (operation.op == 'add' || operation.op == 'replace' || operation.op == 'test') {
							assert(
								'value' in operation,
								'Invalid "'.concat(operation.op, '" operation. Missing "value" property')
							)
							assert(
								Object.keys(operation).length == 3,
								'Invalid "'.concat(operation.op, '" operation. Contains unknown properties')
							)
						} else if (operation.op == 'move' || operation.op == 'copy') {
							assert(
								typeof operation.from == 'string',
								'Invalid "'.concat(operation.op, '" operation. Requires a string "from" property')
							)
							assert(
								Object.keys(operation).length == 3,
								'Invalid "'.concat(operation.op, '" operation. Contains unknown properties')
  ...
  \*********************************/
			/***/ function (__unused_webpack_module, exports, __webpack_require__) {
				...
				__webpack_require__(
					/*! core-js/modules/es.array-buffer.constructor.js */ './node_modules/core-js/modules/es.array-buffer.constructor.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.object.to-string.js */ './node_modules/core-js/modules/es.object.to-string.js'
				)
				...
				__webpack_require__(
					/*! core-js/modules/es.typed-array.uint8-array.js */ './node_modules/core-js/modules/es.typed-array.uint8-array.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.copy-within.js */ './node_modules/core-js/modules/es.typed-array.copy-within.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.every.js */ './node_modules/core-js/modules/es.typed-array.every.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.fill.js */ './node_modules/core-js/modules/es.typed-array.fill.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.filter.js */ './node_modules/core-js/modules/es.typed-array.filter.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.find.js */ './node_modules/core-js/modules/es.typed-array.find.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.find-index.js */ './node_modules/core-js/modules/es.typed-array.find-index.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.for-each.js */ './node_modules/core-js/modules/es.typed-array.for-each.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.includes.js */ './node_modules/core-js/modules/es.typed-array.includes.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.index-of.js */ './node_modules/core-js/modules/es.typed-array.index-of.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.iterator.js */ './node_modules/core-js/modules/es.typed-array.iterator.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.join.js */ './node_modules/core-js/modules/es.typed-array.join.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.last-index-of.js */ './node_modules/core-js/modules/es.typed-array.last-index-of.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.map.js */ './node_modules/core-js/modules/es.typed-array.map.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.reduce.js */ './node_modules/core-js/modules/es.typed-array.reduce.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.reduce-right.js */ './node_modules/core-js/modules/es.typed-array.reduce-right.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.reverse.js */ './node_modules/core-js/modules/es.typed-array.reverse.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.set.js */ './node_modules/core-js/modules/es.typed-array.set.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.slice.js */ './node_modules/core-js/modules/es.typed-array.slice.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.some.js */ './node_modules/core-js/modules/es.typed-array.some.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.sort.js */ './node_modules/core-js/modules/es.typed-array.sort.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.subarray.js */ './node_modules/core-js/modules/es.typed-array.subarray.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.to-locale-string.js */ './node_modules/core-js/modules/es.typed-array.to-locale-string.js'
				)
				__webpack_require__(
					/*! core-js/modules/es.typed-array.to-string.js */ './node_modules/core-js/modules/es.typed-array.to-string.js'
				)
				__webpack_require__(
				...
				exports.signCompactJws =
					exports.importJWK =
					exports.generatePKCEChallenge =
					exports.digestSha256 =
					exports.randomBytes =
						void 0
				var js_base64_1 = __webpack_require__(/*! js-base64 */ './node_modules/js-base64/base64.js')
				var crypto =
					(typeof globalThis === 'undefined' ? 'undefined' : (0, _typeof2.default)(globalThis)) ===
						'object' && globalThis.crypto
						? globalThis.crypto
						: __webpack_require__(
								/*! isomorphic-webcrypto */ './node_modules/isomorphic-webcrypto/src/browser.mjs'
							)['default']
				...
				function _digestSha() {
					_digestSha = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(function _callee2(payload) {
							var prepared, hash
				...
				function _importJWK() {
					_importJWK = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(function _callee3(jwk) {
							return _regenerator.default.wrap(
								function _callee3$(_context3) {
									while (1)
										switch ((_context3.prev = _context3.next)) {
											...
											case 11:
												...
												throw new Error(
													'The '
														.concat(jwk.alg, ' is not supported by this browser: ')
														.concat(_context3.t0)
												)
											case 14:
											case 'end':
				...
				function _signCompactJws() {
					_signCompactJws = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(
							function _callee4(alg, privateKey, header, payload) {
									...
									while (1)
										switch ((_context4.prev = _context4.next)) {
											case 0:
												...
												jwtAuthenticatedContent = ''
													.concat((0, js_base64_1.encodeURL)(jwtHeader), '.')
													.concat((0, js_base64_1.encodeURL)(jwtPayload))
												_context4.next = 5
												return subtle().sign(
													_objectSpread(
														_objectSpread({}, privateKey.algorithm),
														{},
														{
															hash: 'SHA-384',
														}
											...
											case 5:
												...
												return _context4.abrupt(
													'return',
													''
														.concat(jwtAuthenticatedContent, '.')
														.concat(
															(0, js_base64_1.fromUint8Array)(new Uint8Array(signature), true)
														)
												)
											case 7:
											case 'end':
  ...
  \**********************/
			/***/ function (__unused_webpack_module, exports, __webpack_require__) {
				...
				exports.init =
					exports.buildTokenRequest =
					exports.ready =
					exports.onMessage =
					exports.isInPopUp =
					exports.isInFrame =
					exports.authorize =
					exports.getSecurityExtensions =
					exports.fetchWellKnownJson =
					exports.KEY =
						void 0
				/* global window */
				var lib_1 = __webpack_require__(/*! ./lib */ './src/lib.ts')
				...
				function isBrowser() {
					return (
						(typeof window === 'undefined' ? 'undefined' : (0, _typeof2.default)(window)) ===
						'object'
					)
				}
				/**
				...
				function fetchWellKnownJson() {
					...
					return (0, lib_1.getAndCache)(url, requestOptions).catch(function (ex) {
						throw new Error(
							'Failed to fetch the well-known json "'.concat(url, '". ').concat(ex.message)
						)
					})
				}
				...
				function getSecurityExtensionsFromConformanceStatement() {
					var baseUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '/'
					var requestOptions = arguments.length > 1 ? arguments[1] : undefined
					return (0, lib_1.fetchConformanceStatement)(baseUrl, requestOptions).then(
						function (meta) {
							var nsUri = 'http://fhir-registry.smarthealthit.org/StructureDefinition/oauth-uris'
							var extensions = ((0, lib_1.getPath)(meta || {}, 'rest.0.security.extension') || [])
								.filter(function (e) {
									return e.url === nsUri
								})
								.map(function (o) {
				...
				function _authorize() {
					_authorize = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(function _callee(env) {
							var params,
								url,
								urlISS,
								cfg,
								...
								while (1)
									switch ((_context.prev = _context.next)) {
										...
										case 6:
											...
											;(0, lib_1.assert)(
												cfg,
												'No configuration found matching the current "iss" parameter "'.concat(
													urlISS,
													'"'
												)
											)
										...
										case 11:
											...
											;(iss = params.iss),
												...
												(noRedirect = params.noRedirect),
												(_params$scope = params.scope),
												(scope = _params$scope === void 0 ? '' : _params$scope),
										...
										case 33:
											stateKey =
												stateKey !== null && stateKey !== void 0
													? stateKey
													: (0, lib_1.randomString)(16)
											...
											fullSessionStorageSupport = isBrowser()
				...
				function shouldIncludeChallenge(S256supported, pkceMode) {
					...
					if (pkceMode === 'required') {
						if (!S256supported) {
							throw new Error(
								"Required PKCE code challenge method (`S256`) was not found in the server's codeChallengeMethods declaration."
							)
						}
						return true
					}
				...
				function _ready() {
					_ready = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(function _callee2(env) {
							var options,
								_a,
								_b,
								url,
								...
								while (1)
									switch ((_context2.prev = _context2.next)) {
										...
										case 18:
											...
											fullSessionStorageSupport = isBrowser()
												? (0, lib_1.getPath)(env, 'options.fullSessionStorageSupport')
												: true // If we are in a popup window or an iframe and the authorization is
										...
										case 29:
											...
											if (
												isBrowser() &&
												(0, lib_1.getPath)(env, 'options.replaceBrowserHistory') &&
												(code || hasState)
											) {
											...
											authorized =
												!code ||
												((_a = state.tokenResponse) === null || _a === void 0
													? void 0
													: _a.access_token) // If we are authorized already, then this is just a reload.
										...
										case 53:
											debug(
												(
													(_b = state.tokenResponse) === null || _b === void 0
														? void 0
														: _b.access_token
												)
													? 'Already authorized'
				...
				function _buildTokenRequest() {
					_buildTokenRequest = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(function _callee3(env, _ref) {
							var code,
								state,
								clientPublicKeySetUrl,
								privateKey,
									...
									switch ((_context3.prev = _context3.next)) {
										case 0:
											...
											requestOptions = {
												...
												body: 'code='
													.concat(code, '&grant_type=authorization_code&redirect_uri=')
										...
										case 24:
											...
											requestOptions.body += '&client_assertion_type='.concat(
												encodeURIComponent('urn:ietf:params:oauth:client-assertion-type:jwt-bearer')
											)
											requestOptions.body += '&client_assertion='.concat(
				...
				function _init() {
					_init = (0, _asyncToGenerator2.default)(
						/*#__PURE__*/ _regenerator.default.mark(
							function _callee4(env, authorizeOptions, readyOptions) {
									...
									while (1)
										switch ((_context4.prev = _context4.next)) {
											...
											case 17:
												return _context4.abrupt(
													'return',
													authorize(env, authorizeOptions).then(function () {
							...
							value:
								...
								(function () {
									var _get = (0, _asyncToGenerator2.default)(
										/*#__PURE__*/ _regenerator.default.mark(function _callee(key) {
											var value
											return _regenerator.default.wrap(function _callee$(_context) {
												while (1)
													switch ((_context.prev = _context.next)) {
						...
						},
						{
							...
							value: (function () {
								var _unset = (0, _asyncToGenerator2.default)(
									/*#__PURE__*/ _regenerator.default.mark(function _callee3(key) {
										return _regenerator.default.wrap(function _callee3$(_context3) {
											while (1)
												switch ((_context3.prev = _context3.next)) {
													case 0:
  ...
  \**********************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				var isNativeReflectConstruct = __webpack_require__(
					/*! ./isNativeReflectConstruct.js */ './node_modules/@babel/runtime/helpers/isNativeReflectConstruct.js'
				)
  ...
  \************************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				var toPropertyKey = __webpack_require__(
					/*! ./toPropertyKey.js */ './node_modules/@babel/runtime/helpers/toPropertyKey.js'
				)
			...
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				function _regeneratorRuntime() {
					...
					return (
						...
						c(GeneratorFunctionPrototype, u, (GeneratorFunction.displayName = 'GeneratorFunction')),
						(r.isGeneratorFunction = function (t) {
							var r = 'function' == typeof t && t.constructor
							return (
								!!r &&
								(r === GeneratorFunction || 'GeneratorFunction' === (r.displayName || r.name))
							)
						}),
						(r.mark = function (t) {
							return (
  ...
  \**************************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var toPrimitive = __webpack_require__(
					/*! ./toPrimitive.js */ './node_modules/@babel/runtime/helpers/toPrimitive.js'
				)
  ...
  \****************************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var isNativeFunction = __webpack_require__(
					/*! ./isNativeFunction.js */ './node_modules/@babel/runtime/helpers/isNativeFunction.js'
				)
				var construct = __webpack_require__(
					/*! ./construct.js */ './node_modules/@babel/runtime/helpers/construct.js'
				)
  ...
  \******************************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var NATIVE_ARRAY_BUFFER = __webpack_require__(
					/*! ../internals/array-buffer-basic-detection */ './node_modules/core-js/internals/array-buffer-basic-detection.js'
				)
				...
				var isTypedArray = function (it) {
					...
					var klass = classof(it)
					return (
						hasOwn(TypedArrayConstructorsList, klass) || hasOwn(BigIntArrayConstructorsList, klass)
					)
				}
...
*/
					...
					while (sourceIndex < sourceLen) {
						if (sourceIndex in source) {
							...
							if (depth > 0 && isArray(element)) {
								...
								targetIndex =
									flattenIntoArray(target, original, element, elementLen, targetIndex, depth - 1) -
									1
							} else {
  ...
  \*******************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var floatRound = __webpack_require__(
					/*! ../internals/math-float-round */ './node_modules/core-js/internals/math-float-round.js'
				)
  ...
  \*******************************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var TYPED_ARRAYS_CONSTRUCTORS_REQUIRES_WRAPPERS = __webpack_require__(
					/*! ../internals/typed-array-constructors-require-wrappers */ './node_modules/core-js/internals/typed-array-constructors-require-wrappers.js'
				)
				...
				var toUint8Clamped = __webpack_require__(
					/*! ../internals/to-uint8-clamped */ './node_modules/core-js/internals/to-uint8-clamped.js'
				)
				var toPropertyKey = __webpack_require__(
					/*! ../internals/to-property-key */ './node_modules/core-js/internals/to-property-key.js'
				)
				...
				var arrayFromConstructorAndList = __webpack_require__(
					/*! ../internals/array-from-constructor-and-list */ './node_modules/core-js/internals/array-from-constructor-and-list.js'
				)
				var InternalStateModule = __webpack_require__(
					/*! ../internals/internal-state */ './node_modules/core-js/internals/internal-state.js'
				)
				...
				if (DESCRIPTORS) {
					...
					module.exports = function (TYPE, wrapper, CLAMPED) {
						...
						$(
							{ global: true, constructor: true, forced: FORCED, sham: !NATIVE_ARRAY_BUFFER_VIEWS },
							exported
						)
  ...
  \*****************************************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var typedArraySpeciesConstructor = __webpack_require__(
					/*! ../internals/typed-array-species-constructor */ './node_modules/core-js/internals/typed-array-species-constructor.js'
				)
  ...
  \************************************************************/
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var isBigIntArray = __webpack_require__(
					/*! ../internals/is-big-int-array */ './node_modules/core-js/internals/is-big-int-array.js'
				)
				var aTypedArrayConstructor = __webpack_require__(
					/*! ../internals/array-buffer-view-core */ './node_modules/core-js/internals/array-buffer-view-core.js'
				).aTypedArrayConstructor
				var toBigInt = __webpack_require__(
					/*! ../internals/to-big-int */ './node_modules/core-js/internals/to-big-int.js'
				)
			...
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				module.exports = function (originalArray) {
					return aTypedArrayConstructor(
						speciesConstructor(originalArray, getTypedArrayConstructor(originalArray))
					)
				}
  ...
  \*******************************************************/
			/***/ function (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
				...
				var FF = __webpack_require__(
					/*! ../internals/environment-ff-version */ './node_modules/core-js/internals/environment-ff-version.js'
				)
				var IE_OR_EDGE = __webpack_require__(
					/*! ../internals/environment-is-ie-or-edge */ './node_modules/core-js/internals/environment-is-ie-or-edge.js'
				)
				var V8 = __webpack_require__(
					/*! ../internals/environment-v8-version */ './node_modules/core-js/internals/environment-v8-version.js'
				)
				var WEBKIT = __webpack_require__(
					/*! ../internals/environment-webkit-version */ './node_modules/core-js/internals/environment-webkit-version.js'
				)
  ...
  \***************************************************************/
			/***/ function (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
				...
				var proxyAccessor = __webpack_require__(
					/*! ../internals/proxy-accessor */ './node_modules/core-js/internals/proxy-accessor.js'
				)
				var defineBuiltIn = __webpack_require__(
					/*! ../internals/define-built-in */ './node_modules/core-js/internals/define-built-in.js'
				)
  ...
  \***************************************************************/
			/***/ function (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
				...
				var fromSpeciesAndList = __webpack_require__(
					/*! ../internals/typed-array-from-species-and-list */ './node_modules/core-js/internals/typed-array-from-species-and-list.js'
				)
			...
			/***/ function (module, __unused_webpack_exports, __webpack_require__) {
				...
				var utf8Decode = function (octets) {
					...
					switch (octets.length) {
						...
						case 3:
							codePoint =
								((octets[0] & 0x0f) << 12) | ((octets[1] & 0x3f) << 6) | (octets[2] & 0x3f)
							break
						case 4:
							codePoint =
								((octets[0] & 0x07) << 18) |
  ...
  \*************************************************************/
			/***/ function (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
				...
				var toASCII = __webpack_require__(
					/*! ../internals/string-punycode-to-ascii */ './node_modules/core-js/internals/string-punycode-to-ascii.js'
				)
				var $toString = __webpack_require__(
					/*! ../internals/to-string */ './node_modules/core-js/internals/to-string.js'
				)
				...
				URLState.prototype = {
								...
								case PORT:
									if (exec(DIGIT, chr)) {
										...
										if (buffer !== '') {
											...
											url.port =
												url.isSpecial() && port === specialSchemes[url.scheme] ? null : port
											buffer = ''
										}
										if (stateOverride) return
										state = PATH_START
								...
								case FILE:
									...
									if (chr === '/' || chr === '\\') state = FILE_SLASH
										...
										switch (chr) {
											...
											default:
												if (
													!startsWithWindowsDriveLetter(join(arraySlice(codePoints, pointer), ''))
												) {
													url.host = base.host
													url.path = arraySlice(base.path)
													url.shortenPath()
					...
					shortenPath: function () {
						...
						if (
							pathSize &&
							(this.scheme !== 'file' || pathSize !== 1 || !isWindowsDriveLetter(path[0], true))
						) {
							path.length--
						}
					},
  ...
  \*************************************************/
			/***/ function (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
				...
				// TODO: Remove this module from `core-js@4` since it's replaced to module below
				__webpack_require__(
					/*! ../modules/web.url.constructor */ './node_modules/core-js/modules/web.url.constructor.js'
				)
  ...
  \***********************************************************/
			/***/ function (
				...
				'use strict'
				/* harmony import */ var _webcrypto_shim_mjs__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(
						/*! ./webcrypto-shim.mjs */ './node_modules/isomorphic-webcrypto/src/webcrypto-shim.mjs'
					)
					...
					;['generateKey', 'importKey', 'unwrapKey'].forEach(function (m) {
						...
						_subtle[m] = function (a, b, c) {
							...
							if (m === 'generateKey' && ka.name === 'HMAC' && ka.hash) {
								ka.length =
									ka.length ||
									{ 'SHA-1': 512, 'SHA-256': 512, 'SHA-384': 1024, 'SHA-512': 1024 }[ka.hash.name]
