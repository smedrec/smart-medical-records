	...
	general: {
		...
		items: [
			...
			},
			{
				...
				question: 'How can I contribute to or request new features for the library?',
				answer:
		...
		items: [
			{
				...
				answer: 'Our icons are available in multiple formats including SVG, PDF, and AI files.',
			},
		],
	},
	library: {
