...
import { SidebarMenuButton, SidebarMenuItem } from '@repo/ui/components/ui/sidebar'
		...
		if (
			...
			toast.success(
				<>
					...
					<div className="flex items-center gap-2">
						...
						<span>Successfully reconnected to server.</span>
					</div>
				</>
			)
			...
			toast.error(
				<>
					...
					<div className="flex items-center gap-2">
						<span>Attempting to reconnect to the SMEDREC server...</span>
					</div>
				</>
			)
		}
				...
				{showingError && (
					<TooltipContent side="top" align="center" className="max-w-xs">
						<div className="flex flex-col gap-2">
							...
							<p className="text-xs">Please ensure the server is running and accessible.</p>
							{!isUnauthorized && (
